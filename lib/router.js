...
router.get('/ssdut/:type?', require('./routes/universities/dut/ssdut'))
...
router.get('/xjtu/ll/:id?', lazyloadRouteHandler('./routes/universities/xjtu/ee'))

router.get('/xjtu/se/:type?', lazyloadRouteHandler('./routes/universities/xjtu/ee'))
